...
#   julia --project=. scripts/profile/profile_bem.jl
#   julia --project=. scripts/profile/profile_bem.jl --ndiv=40
# =============================================================================
...
function profile_pipeline(; ndiv::Int=20)
  ...
  • Solve: LU O(N³) for dense A; GMRES for H-matrix / BlockMixedOperator.
  ...
  3. Package load / precompile (Plots/GR, DiffEq) — not runtime of solve.
  ...
  • Lazy-load Plots/OrdinaryDiffEq to cut precompile & `using` time.
