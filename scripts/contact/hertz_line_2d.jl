...
fig = plot(x, sol.p; label="BEM Flamant", xlabel="x", ylabel="p",
    title="Line contact pressure", size=(800, 400), legend=:topright)
plot!(fig, x, p_hz; label="Hertz", linestyle=:dash)
display(fig)
println("Done.")
